...
def generate_f_vs_phi_plot_from_csv(csv_path, output_dir='science/analysis/version_4/cff_plots'):
    """
...
def generate_plots_from_csv(csv_path, output_dir='science/analysis/version_4/cff_plots'):
    """
